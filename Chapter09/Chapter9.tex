...
\centering
\includegraphics[width=0.8\textwidth]{Chapter09/figures/feature_completion_dashboard.PDF}
...
\begin{sidewaysfigure}[h]
\centering  
\includegraphics[width=0.8\textwidth]{Chapter09/figures/response_time_analysis.PDF}
...
\begin{sidewaysfigure}[h]
\centering
\includegraphics[width=0.8\textwidth]{Chapter09/figures/horizontal_scaling_performance.PDF}
...
\begin{sidewaysfigure}[h]
\centering
\includegraphics[width=0.8\textwidth]{Chapter09/figures/security_control_coverage.PDF}
